...
export function MarketSizeModel() {
  return (
        ...
        <div className="absolute w-full pb-[2rem] px-[30px] transition animate-tabappear z-10">
          <div className="mt-[48px]">
            <Typography className="text-[#333333] text-[32px] font-bold">
              Market Size Model Analytics Dashboard - <span className="text-darkred-600">GTK</span>
            </Typography>
          </div>
          ...
          <div className="mt-[20px]">
            <Typography className="text-base font-medium text-[#808080]">
              ...
              <span className="text-[#9f123a]">ATC 2, ATC 3 & ATC 4</span>
            </Typography>
              ...
              <Card className="p-4">
                ...
                <div className="mt-[30px]"><div className="grid grid-cols-1 gap-2 lg:flex lg:justify-between">
                    <div className="lg:w-[50%] 2xl:w-[40%]">
                      <StatisticsChart chart={level2ChartData1} />
                    </div>
                    <div className="lg:grow">
                      <div className="grid grid-cols-1 gap-2 2xl:flex lg:justify-between">
                        <div className="grow">
                          <Flowbite.TextInput icon={MagnifyingGlassIcon} placeholder="Year" style={{height: "48px", minWidth: "262px", flex: 1, background: "white"}} />
                        </div>
            ...
            <div className="mt-[6px]">
              <Card className="p-4">
                ...
                <div className="mt-[30px]"><div className="grid grid-cols-1 gap-2 lg:flex lg:justify-between">
                    <div className="lg:w-[50%] 2xl:w-[40%]">
                      <StatisticsChart chart={level2ChartData2} />
                    </div>
                    <div className="lg:grow">
                      <div className="grid grid-cols-1 gap-2 2xl:flex lg:justify-between">
                        <div className="grow">
                        ...
                        <div className="flex gap-2">
                          <Flowbite.TextInput icon={MagnifyingGlassIcon} placeholder="%" style={{height: "48px", minWidth: "142px", flex: 1, background: "white"}} />
                          <Flowbite.TextInput icon={MagnifyingGlassIcon} placeholder="Naira" style={{height: "48px", minWidth: "116px", flex: 1, background: "white"}} />
                          <button className="px-[23px] py-[10px] rounded border border-[#e6e6e6] bg-white hover:bg-[#eeeeee] shadow-[0_15px_60px_rgba(173,173,173,0.2]">
                            <Typography className="font-bold text-base text-darkred-600">
                              <FunnelIcon className="w-5 h-5" />
                            </Typography>
