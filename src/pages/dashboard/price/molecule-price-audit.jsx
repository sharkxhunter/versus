...
const level2TableData = {
  headers: [
    "Molecule", "Currency (Naira)", "% Change in price"
  ],
  data: [
    ["Simenthicone", "12,000", "-0.06%"],
    ["Magnesium Trisilicate", "12,000", "+2.33%"],
    ["Femotidine", "12,000", "+2.33%"],
    ["Clacifediol", "12,000", "-0.06%"],
    ["Metformin + Gliclazide", "12,000", "+2.33%"],
  ]
}
...
export function MoleculePriceAudit() {
  return (
        ...
        <div className="absolute w-full pb-[2rem] px-[30px] transition animate-tabappear z-10">
          <div className="mt-[48px]">
            <Typography className="text-[#333333] text-[32px] font-bold">
              Molecule Price Audit Dashboard
            </Typography>
          </div>
          ...
          <div className="mt-[20px]">
            <Typography className="text-base font-medium text-[#808080]">
              ...
              <span className="text-[#9f123a]">ATC 5</span>
            </Typography>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-[25px]">
                    <Typography className="font-bold text-[18px]">
                      % Molecule share for each Theraphy Area Level - <span className="text-[#9f123a]">ATC Level 5</span>
                    </Typography>
                  </div>
                ...
                <div className="mt-[30px]"><div className="grid grid-cols-1 gap-2 lg:flex lg:justify-between">
                    ...
                    <div className="lg:grow">
                      <div className="grid grid-cols-1 gap-2 2xl:flex lg:justify-between">
                        <div className="grow">
                          <Flowbite.TextInput icon={MagnifyingGlassIcon} placeholder="Molecule" style={{height: "48px", minWidth: "262px", flex: 1, background: "white"}} />
                        </div>
                        <div className="flex gap-2">
                          ...
                          <Flowbite.TextInput icon={MagnifyingGlassIcon} placeholder="% change in price" style={{height: "48px", minWidth: "130px", flex: 1, background: "white"}} />
